...
export const DEMO_SCENARIOS: DemoScenario[] = [
  {
    ...
    summary: "Known recipient, normal spending pattern.",
  ...
  },
  {
    ...
    summary: "Recurring transfer to a long-saved family member.",
  ...
  },
  {
    ...
    summary: "Recognized recipient, but sender is on an unrecognized device.",
  ...
  },
  {
    ...
    summary: "First-time recipient receiving an unusually large transfer.",
  ...
  },
  {
    ...
    summary: "Several transfers to an unfamiliar account within minutes.",
